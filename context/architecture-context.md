...
- Canvas content and markdown output are stored in a retreived from Vercel Blob.
...
- Templates do not required a separate database record; they are resolved by template ID at import time.
