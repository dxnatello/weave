...
# This is not NOT the Next.js you know

This version has breaking changes - APIs, conventions and file structure may all differ from your training data. Read the relavent guide in `node_modules/next/dist/docs/` before writing any code. Heed deprecation notices.
